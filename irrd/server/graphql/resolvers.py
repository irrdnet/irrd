...
def convert_kwargs_to_snake_case(func):
    ...
    # snake_case keys on the resolver's returned dicts, which breaks every
    # IRRD field that emits camelCase keys. This is a simplified vendoring
    # of ariadne's old function.
    @wraps(func)
