...
MOCK_ROUTE_COMBINED_WITH_RPKI = MOCK_ROUTE1 + 'rpki-validation-state: not_found # No ROAs found, or RPKI validation not enabled for source\n\n' + MOCK_ROUTE2 + 'rpki-validation-state: valid\n\n' + MOCK_ROUTE3 + 'rpki-validation-state: valid'
