...
def upgrade():
    ...
    op.create_index(op.f('ix_change_log_auth_affected_mntner'), 'change_log', ['auth_affected_mntner'], unique=False)
    op.create_index(op.f('ix_change_log_auth_through_mntner_id'), 'change_log', ['auth_through_mntner_id'], unique=False)
